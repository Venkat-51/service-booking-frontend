    ...
    <div className="container mx-auto px-4 py-20 max-w-md">
      ...
      <Card className="border-none shadow-2xl rounded-3xl overflow-hidden bg-white">
        <CardHeader className="text-center p-8 pb-0">
          ...
          <CardDescription>
            {isLogin ? 'Sign in to access your bookings' : 'Join BookMyService to find local experts'}
          </CardDescription>
        </CardHeader>
        <CardContent className="p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full h-12 rounded-xl text-lg font-bold mt-4" disabled={loading}>
